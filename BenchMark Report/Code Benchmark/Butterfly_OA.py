...
def butterfly_optimization_algorithm(objective_function, bounds, num_butterflies=10, max_iter=50, c = 0.4, a = 0.0001, p = 0.6, fixed_nodes = [], fixed_values = []):

    #initializing the population
    butterflies = [Butterfly(bounds) for _ in range(num_butterflies)]
...
#for every iteration
    for i in range(max_iter):
        ...
        for butterfly in butterflies:
            ...
            if current_fitness < butterfly.fitness:
        ...
        print(f'Posizione migliore trovata: {best_butterfly.position}')
        print(f'Migliore fitness trovata: {best_butterfly.fitness}')
